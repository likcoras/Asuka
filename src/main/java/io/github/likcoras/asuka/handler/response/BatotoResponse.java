...
public class BatotoResponse implements BotResponse {
	...
	private static final String FORMAT = BotUtil.addFormat("&bName:&b %s | &bAuthor:&b %s | &bTags:&b %s | &bStatus:&b %s | &bLink:&b %s");
	
	private GenericMessageEvent<PircBotX> event;
	private String message;
	
	public BatotoResponse(GenericMessageEvent<PircBotX> event, String title, String author, String genres, String status, String link) {
		this.event = event;
